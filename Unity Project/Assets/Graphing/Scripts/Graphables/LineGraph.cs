...
namespace Graphing
{
    ...
    public class LineGraph : Graphable, ILineGraph
    {
        ...
        public virtual string GetFormattedValueAt(float x, float y, float width, float height, bool withName = false)
        {
            ...
            if (effectiveUnit == "-")
                effectiveUnit = "";
            return string.Format("{2}{0:" + StringFormat + "}{1}", ValueAt(x, y, width, height), effectiveUnit, withName && DisplayName != "" ? DisplayName + ": " : "");
        }
        ...
        public virtual void WriteToDataTable(System.Data.DataTable dataTable, bool includeX)
        {
            ...
            System.Data.DataColumn yColumn = dataTable.Columns.Add(IO.GraphIO.GetUniqueColumnName(dataTable, FormatNameAndUnit(yDisplayName, YUnit, "Y")), typeof(float));
